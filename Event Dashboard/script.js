...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const API_URL_CREATE = "https://project-community-xi.vercel.app/community/api/v1/event/create";
    const API_URL_FETCH = "https://project-community-xi.vercel.app/community/api/v1/event/getallevents";
    const API_URL_REGISTER = "https://project-community-xi.vercel.app/community/api/v1/event/register"; // Add your registration endpoint

    let currentEventDetails = {}; // Object to store current event details
    ...
    function createEventElement(eventData) {
        ...
        // Add event listener for register button to show registration modal and store event details
        registerButton.addEventListener('click', () => {
            currentEventDetails = {
                // eventId: eventData._id, // Assuming the event ID is stored in the `_id` field
